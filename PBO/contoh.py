...
class Melati(plant):
    ...
    # def tampil ():
    #     beri_air = input("masukan jumlah air : ")
    #     beri_pupuk = input("masukan jumlah pupuk : ")


tanaman1 = Anggrek("Anggrek")
# bunga_mawar = Mawar ("Maawar")
# bunga_melati = Melati ("Melati")    


# tanaman1 = Anggrek(0,0,0,"anggrek")
# tanaman2 = Mawar(0,0,0,"mawar")
# tanaman3 = Melati(0,0,0,"melati")
# tanaman1 = Anggrek( 0, 0, 0, 'Anggrek')
...
def pilihan(*args):
    ...
    btn_air = ttk.Button(frm,text="1.Beri Air", command= tanaman1())
...
btn_m = ttk.Button(frm,text="2.Mawar")
