...
def main(*args):
    ...
    btn_a = ttk.Button(frm,text="1.Anggrek",command=lambda: [pilih(bunga1,judul,btn_a,btn_m,btn_mel,btn_exit)])
    btn_a.pack(padx=10,pady=5,fil="x",expand=True)

    btn_m = ttk.Button(frm,text="2.Mawar",command=lambda: [pilih(bunga2,judul,btn_a,btn_m,btn_mel,btn_exit)])
    btn_m.pack(padx=10,pady=5,fil="x",expand=True)

    btn_mel = ttk.Button(frm,text="3.Melati",command=lambda: [pilih(bunga3,judul,btn_a,btn_m,btn_mel,btn_exit)])
